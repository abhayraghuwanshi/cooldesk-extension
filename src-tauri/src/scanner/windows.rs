// Windows installed-app + running-window scanner — the Win32 half of the
// process/app discovery pipeline. See `scanner.rs` for the module-level
// overview; output feeds `matcher::match_apps`.
